...
class OrdersController extends Controller
{
   ...
   */
    ...
    public function show(Orders_model $order)
    {
        $products = $order->products;
        $orders = Orders_model::where('users_id',Auth::id())->first();

        return view('frontEnd.users.account')->with([
            'orders'=>$orders,
                'products'=>$products,]
         );
    }
