...
class CouponController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('coupon.index')->with('message','Success!');
    }
    ...
    public function applycoupon(Request $request){
        ...
        if($check_coupon==0){
            return back()->with('message_coupon','Coupon Code Not Valid!');
            ...
            if($check_status->status==0){
                ...
                if($expiried_date<$date_now){
                    ...
                    $discount_amount_price=($total_amount_price/$check_status->amount);
                    Session::put('discount_amount_price',$discount_amount_price);
                    Session::put('coupon_code',$check_status->coupon_code);
                    return back()->with('message_apply_sucess','Coupon Code Applied');
                }
            }
        }
    }
